...
const formSchema = z.object({
  ...
  representanteLegal: z.string().max(120, {
...
export const FormClient = ({ selectedClient, update, closeSheet }: FormClientProps) => {
