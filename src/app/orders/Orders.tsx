              ...
              {loading ? (
                ...
                <DataTable
                  ...
                  columns={[
                    ...
                    { header: 'autoriza', accessorKey: 'autoriza' },
                    ...
                    { header: 'Código del articulo', accessorKey: 'cod_art_mc_pr' },
                    { header: 'Descripción del articulo', accessorKey: 'cod_bar_mc_pr' },
                    ...
                    { header: 'Procinto ieps', accessorKey: 'porciento_ieps' },
                    { header: 'Precio', accessorKey: 'precio' },
                    { header: 'Programa orden', accessorKey: 'prog_ord' },
                    { header: 'Programa pedido', accessorKey: 'prog_ped' },
                    ...
                    { header: 'Total pedido', accessorKey: 'total_ped' },
                  ]}
                />
              )}
